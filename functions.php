...
function responsive_js() {
	...
	wp_register_script('jquery-1.8.3', get_stylesheet_directory_uri() . '/js/scripts.js', true);
	...
	wp_enqueue_script('jquery-1.8.3');
	wp_enqueue_script('plugins');
}
add_action('wp_enqueue_scripts', 'responsive_js', 5);

function responsive_css() {
	wp_register_style('found-style', get_stylesheet_directory_uri() . '/css/3.2.min.css', array(), 'all');
