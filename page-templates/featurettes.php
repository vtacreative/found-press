...
get_header(); ?>
	...
	<section class="secondary dark-wall">
		...
		<div class="row">
			...
			<div class="large-2 columns" role="main">
	...
	<section class="tertiary">
		...
		<div class="row featurettes">
			<div class="large-5 columns">
				<div class="box effect2 left">
					<img src="http://placehold.it/320x240">
				</div>
			</div>
			<div class="large-7 columns">
				<h1>Hit The Ground Running</h1>
				<p>found-press uses <a href="http://foundation.zurb.com/">Foundation</a>, <a href="http://www.wordpress.org/">WordPress</a> and some other goodies to create a toolkit for responsive theme development. Speed up your workflow and hit the ground running with over thousands of hours of tested code. <a class="read-more-1" href="#">&rarr;</a></p>
			</div>
		</div>
		...
		<div class="row featurettes">
			<div class="large-5 push-7 columns">
				<div class="box effect4 right">
					<img src="http://placehold.it/320x240">
				</div>
			</div>
			<div class="large-7 pull-5 columns">
				<h1>Who's This For?</h1>
				<p>Anyone who likes Foundation and builds a lot of WordPress themes. I build a lot of WordPress themes with Foundation and got sick of doing the same basic "preparation" steps over and over so I cobbled some snippets and resources together and called it "found-press." So far it's proven pretty useful. <a href="#">&rarr;</a></p>
			</div>
		</div>
		...
		<div class="row featurettes">
			<div class="large-5 columns">
				<div class="box effect3 left">
					<img src="http://placehold.it/320x240">
				</div>
			</div>
			<div class="large-7 columns">
				<h1>Handy Effects Library</h1>
				<p>found-press gives developers easy access to some pretty cool extras, including the entire Subtle Patterns background library, all four sets of Foundicons, some box shadow effects from Paul Underwood, and a color gist for easy positioning. Don't need the code footprint, you say? You can easily remove whatever you don't need. <a class="read-more-1" href="#">&rarr;</a></p>
			</div>
		</div>
